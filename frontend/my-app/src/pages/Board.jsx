  ...
  return (
    <div className="board-wrapper">
      ...
      <DragDropContext onDragEnd={onDragEnd}>
        <div className="board">
          <Column title="To Do" status="todo" color="#6366f1" tasks={tasks}
            onAdd={() => { setFormStatus("todo"); setShowForm(true); }} />

          <Column title="In Progress" status="in-progress" color="#7c3aed" tasks={tasks}
            onAdd={() => { setFormStatus("in-progress"); setShowForm(true); }} />

          <Column title="Done" status="done" color="#22c55e" tasks={tasks}
...
const Card = ({ task }) => (
  <div className="card">
    ...
    <div className="card-footer">
      ...
      <img
        src={`https://i.pravatar.cc/150?u=${task._id}`}
